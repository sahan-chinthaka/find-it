...
export default function FoundItemsClient({ initialItems }: { initialItems: FoundItem[] }) {
    ...
    <>
      <div className="space-y-4">
        <div className="flex gap-3 flex-wrap">
          ...
          <select
            className="rounded-md border border-slate-200 bg-white px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
            value={typeFilter}
      ...
      {filteredItems.length === 0 ? (
        <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 p-8 text-center">
          <p className="text-slate-600">No found items match your search criteria.</p>
        </div>
      ) : (
